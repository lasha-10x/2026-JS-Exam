/* ==========================================================================
   10X CRM — Auth guard (P0.1) + session storage
   One shared place for access-control logic and the session storage
   ...
   User accounts themselves (getUsers/saveUsers) now live in Supabase —
   see js/db.js — so a signup is visible from any device, not just the
   browser that created it. Session state (who is currently logged in on
   *this* browser) is still local; that's meant to be per-device.
   ========================================================================== */
